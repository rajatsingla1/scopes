<template>
  <div
    class="mx-auto max-w-6xl px-4 md:mt-32 sm:px-6 lg:px-8 rounded-lg ring-1 ring-slate-900/10 custom-shadow"
  >
    <div class="mt-0 flow-root">
      <div
        class="-mx-4 my-0 sm:-mx-6 lg:-mx-8 overflow-x-scroll lg:overflow-visible"
      >
          ...
          <table class="min-w-full border-separate border-spacing-0">
            <thead>
              <tr>
                ...
                <th
                  scope="col"
                  class="sticky top-[0px] z-10 border-b border-gray-300 bg-white bg-opacity-75 px-3 py-1.5 text-left text-sm font-semibold text-gray-900 backdrop-blur backdrop-filter w-32"
                >
            ...
            <tbody>
              ...
              >
                <td
                  class="relative whitespace-wrap border-b border-gray-200 py-4 pr-4 text-right text-lg text-gray-500 font-medium md:pr-4"
                >
                  {{ index + 1 }}
                </td>
                <td
                  class="whitespace-wrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm font-medium sm:pl-6 lg:pl-8"
                >
                  <h1
                    class="text-base lg:text-lg text-gray-900 mb-1 font-normal"
                  >
                    {{ corporate.company }}
                  </h1>
